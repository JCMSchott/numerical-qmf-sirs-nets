...
loop_grau:         do i2 = this%degMin, this%degMax-1
                ...
                write(*,*) ""
                write(*,*) "Modulo geraRede.f90"
                write(*,*) "Entre linhas 449 e 467"
                write(*,*) "Intervalo para aceitar distribuicao de graus ", relogio%t_tot
                write(*,*) ""
...
!#######################################################################
	...
	enddo loop_stubs
    call relogio%toc()
    write(*,*) "Tempo duracao ligacao stubs (sem correcao): ", relogio%t_tot
!#######################################################################
...
!#######################################################################							
			...
			write(*,*) "Tempo apos ligar os stubs: ", relogio%t_tot
	end subroutine		
